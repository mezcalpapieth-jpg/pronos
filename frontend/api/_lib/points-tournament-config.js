...
export const TOURNAMENT_OPERATION_CLOSE_ISO = '2026-08-25T18:00:00.000Z';
...
export const TOURNAMENT_MIN_ENTRY_MXNP = 300;
export const TOURNAMENT_MAX_SHARES_PER_MARKET = 6000;
export const TOURNAMENT_QUALIFYING_MARKETS = 3;
