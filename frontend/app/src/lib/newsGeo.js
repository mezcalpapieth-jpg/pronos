...
const CITY_ENTITIES = [
  { id: 'guadalajara', name: 'Guadalajara', aliases: ['guadalajara', 'jalisco'], region: 'mexico', country: 'MX', lat: 20.6597, lng: -103.3496 },
  { id: 'cdmx', name: 'Ciudad de México', aliases: ['ciudad de mexico', 'cdmx', 'capital mexicana'], region: 'mexico', country: 'MX', lat: 19.4326, lng: -99.1332 },
  { id: 'monterrey', name: 'Monterrey', aliases: ['monterrey', 'nuevo leon', 'nuevo león'], region: 'mexico', country: 'MX', lat: 25.6866, lng: -100.3161 },
  { id: 'puebla', name: 'Puebla', aliases: ['puebla'], region: 'mexico', country: 'MX', lat: 19.0414, lng: -98.2063 },
  { id: 'queretaro', name: 'Querétaro', aliases: ['queretaro', 'querétaro'], region: 'mexico', country: 'MX', lat: 20.5888, lng: -100.3899 },
  { id: 'tijuana', name: 'Tijuana', aliases: ['tijuana'], region: 'mexico', country: 'MX', lat: 32.5149, lng: -117.0382 },
  { id: 'cancun', name: 'Cancún', aliases: ['cancun', 'cancún', 'quintana roo'], region: 'mexico', country: 'MX', lat: 21.1619, lng: -86.8515 },
  { id: 'merida', name: 'Mérida', aliases: ['merida', 'mérida', 'yucatan', 'yucatán'], region: 'mexico', country: 'MX', lat: 20.9674, lng: -89.5926 },
  { id: 'los-angeles', name: 'Los Ángeles', aliases: ['los angeles', 'los ángeles'], region: 'us-canada', country: 'US', lat: 34.0522, lng: -118.2437 },
  { id: 'new-york', name: 'Nueva York', aliases: ['nueva york', 'new york'], region: 'us-canada', country: 'US', lat: 40.7128, lng: -74.0060 },
  { id: 'washington', name: 'Washington', aliases: ['washington', 'washington dc'], region: 'us-canada', country: 'US', lat: 38.9072, lng: -77.0369 },
