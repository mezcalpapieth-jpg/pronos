...
export const TOURNAMENT_CONVICTION_BONUS_RATE = 0.5;
export const TOURNAMENT_CONVICTION_MAX_MULTIPLIER = 1.5;
export const TOURNAMENT_CONVICTION_MAX_ENTRY_PRICE = 0.85;
export const TOURNAMENT_CONVICTION_NET_PNL_CAP_RATE = 0.5;
export const TOURNAMENT_CONVICTION_MIN_MARKET_ENTRY_MXNP = TOURNAMENT_MIN_ENTRY_MXNP;
...
export function tournamentRulesPayload() {
  return {
    ...
    convictionMultiplier: {
      bonusRate: TOURNAMENT_CONVICTION_BONUS_RATE,
      maxMultiplier: TOURNAMENT_CONVICTION_MAX_MULTIPLIER,
      maxEntryPrice: TOURNAMENT_CONVICTION_MAX_ENTRY_PRICE,
      netPnlCapRate: TOURNAMENT_CONVICTION_NET_PNL_CAP_RATE,
      minMarketEntryMxnp: TOURNAMENT_CONVICTION_MIN_MARKET_ENTRY_MXNP,
