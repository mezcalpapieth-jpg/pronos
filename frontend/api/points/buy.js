 ...
 *
 * Off-chain MXNP buy. The locked trading math lives in
...
import { executePointsBuy } from '../_lib/points-trading-service.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await withTransaction((client) => executePointsBuy(client, {
      username,
      marketId: mid,
      outcomeIndex: oi,
      collateral: amt,
