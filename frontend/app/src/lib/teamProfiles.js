...
const SOCCER_TEAMS = [
  ...
  // MLS
  ['atlanta-united-fc', 'Atlanta United FC', 'MLS', 'Estados Unidos', ['Atlanta United', 'ATL UTD']],
  ['austin-fc', 'Austin FC', 'MLS', 'Estados Unidos', ['Austin']],
  ['cf-montreal', 'CF Montréal', 'MLS', 'Canadá', ['CF Montreal', 'Montréal', 'Montreal', 'Montreal Impact']],
  ['charlotte-fc', 'Charlotte FC', 'MLS', 'Estados Unidos', ['Charlotte']],
  ['chicago-fire-fc', 'Chicago Fire FC', 'MLS', 'Estados Unidos', ['Chicago Fire', 'Fire']],
  ['fc-cincinnati', 'FC Cincinnati', 'MLS', 'Estados Unidos', ['Cincinnati']],
  ['colorado-rapids', 'Colorado Rapids', 'MLS', 'Estados Unidos', ['Rapids']],
  ['columbus-crew', 'Columbus Crew', 'MLS', 'Estados Unidos', ['Crew']],
  ['dc-united', 'D.C. United', 'MLS', 'Estados Unidos', ['DC United', 'D C United', 'Washington DC United']],
  ['fc-dallas', 'FC Dallas', 'MLS', 'Estados Unidos', ['Dallas']],
  ['houston-dynamo-fc', 'Houston Dynamo FC', 'MLS', 'Estados Unidos', ['Houston Dynamo', 'Dynamo']],
  ['inter-miami-cf', 'Inter Miami CF', 'MLS', 'Estados Unidos', ['Inter Miami', 'Miami']],
  ['sporting-kansas-city', 'Sporting Kansas City', 'MLS', 'Estados Unidos', ['Sporting KC', 'Kansas City', 'SKC']],
  ['la-galaxy', 'LA Galaxy', 'MLS', 'Estados Unidos', ['Los Angeles Galaxy', 'Galaxy']],
  ['los-angeles-fc', 'Los Angeles FC', 'MLS', 'Estados Unidos', ['Los Angeles Football Club', 'LAFC', 'LA FC']],
  ['minnesota-united-fc', 'Minnesota United FC', 'MLS', 'Estados Unidos', ['Minnesota United', 'Minnesota']],
  ['nashville-sc', 'Nashville SC', 'MLS', 'Estados Unidos', ['Nashville']],
  ['new-england-revolution', 'New England Revolution', 'MLS', 'Estados Unidos', ['New England', 'Revolution']],
  ['new-york-city-fc', 'New York City FC', 'MLS', 'Estados Unidos', ['NYCFC', 'NYC FC']],
  ['new-york-red-bulls', 'New York Red Bulls', 'MLS', 'Estados Unidos', ['Red Bull New York', 'NY Red Bulls', 'Red Bulls']],
  ['orlando-city-sc', 'Orlando City SC', 'MLS', 'Estados Unidos', ['Orlando City', 'Orlando']],
  ['philadelphia-union', 'Philadelphia Union', 'MLS', 'Estados Unidos', ['Union']],
  ['portland-timbers', 'Portland Timbers', 'MLS', 'Estados Unidos', ['Timbers']],
  ['real-salt-lake', 'Real Salt Lake', 'MLS', 'Estados Unidos', ['RSL']],
  ['san-diego-fc', 'San Diego FC', 'MLS', 'Estados Unidos', ['San Diego']],
  ['san-jose-earthquakes', 'San Jose Earthquakes', 'MLS', 'Estados Unidos', ['San José Earthquakes', 'San Jose', 'Earthquakes']],
  ['seattle-sounders-fc', 'Seattle Sounders FC', 'MLS', 'Estados Unidos', ['Seattle Sounders', 'Sounders']],
  ['st-louis-city-sc', 'St. Louis CITY SC', 'MLS', 'Estados Unidos', ['St Louis CITY SC', 'St. Louis City', 'St Louis City', 'STL City']],
  ['toronto-fc', 'Toronto FC', 'MLS', 'Canadá', ['Toronto']],
  ['vancouver-whitecaps-fc', 'Vancouver Whitecaps FC', 'MLS', 'Canadá', ['Vancouver Whitecaps', 'Whitecaps']],
