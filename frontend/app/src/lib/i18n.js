...
const STRINGS = {
  ...
  'points.detail.leagueTableKicker': { es: 'Tabla',             en: 'Table' },
  'points.detail.leagueTableTitle': { es: 'Posiciones',         en: 'Standings' },
  'points.detail.leagueTableLoading': { es: 'Cargando tabla...', en: 'Loading table...' },
  'points.detail.leagueTableUnavailable': { es: 'Tabla no disponible.', en: 'Table unavailable.' },
  'points.detail.leagueTableEmpty': { es: 'Sin posiciones disponibles.', en: 'No standings available.' },
  'points.detail.leagueTableGroups': { es: 'Grupos',            en: 'Groups' },
  'points.detail.leagueTableTeam':  { es: 'Equipo',             en: 'Team' },
  'points.detail.leagueTablePlayed': { es: 'PJ',                en: 'P' },
  'points.detail.leagueTableDiff':  { es: 'DG',                 en: 'GD' },
  'points.detail.leagueTablePoints': { es: 'Pts',               en: 'Pts' },
  ...
  'points.detail.temperatureResolutionBody': { es: 'Usamos la temperatura máxima horaria registrada por Open-Meteo Archive en best_match para la fecha y ciudad del mercado. No redondeamos: 25°C gana de 25.00°C a 25.99°C, 26°C gana de 26.00°C a 26.99°C, <25°C gana abajo de 25.00°C y ≥27°C gana desde 27.00°C. El mercado cierra antes de que termine el día para evitar operar con el resultado ya evidente.', en: 'We use the hourly maximum temperature recorded by Open-Meteo Archive best_match for the market date and city. We do not round: 25°C wins from 25.00°C to 25.99°C, 26°C wins from 26.00°C to 26.99°C, <25°C wins below 25.00°C, and ≥27°C wins from 27.00°C. The market closes before the day ends to prevent trading once the result is already clear.' },
  'points.detail.orderBook':       { es: 'Libro de órdenes',    en: 'Order book' },
  'points.detail.orderBookHint':   { es: 'Profundidad para comprar, vender y ganar recompensas por dar liquidez.', en: 'Depth for buys, sells, and liquidity rewards.' },
  ...
  'points.detail.limitOrderMakerReward': { es: 'Las órdenes cercanas al precio actual pueden acumular una recompensa por dar liquidez mientras esperan.', en: 'Orders near the current price can accrue a capped liquidity reward while they wait.' },
  'points.detail.limitOrderRewardEarned': { es: 'Recompensa por dar liquidez', en: 'Liquidity reward' },
  ...
  'points.activity.tapeTitle': { es: 'Últimos movimientos',   en: 'Latest moves' },
  'points.activity.tapeLive':  { es: 'en vivo',               en: 'live' },
  'points.activity.tapeBought': { es: 'compró',               en: 'bought' },
  'points.activity.tapeSold':  { es: 'vendió',                en: 'sold' },
  'points.activity.tapeUser':  { es: 'usuario',               en: 'user' },
  'points.activity.tapeOutcome': { es: 'resultado',           en: 'outcome' },
  'points.activity.tapeShares': { es: 'acc.',                 en: 'sh.' },
  'points.activity.detailsShow': { es: 'Detalles',            en: 'Details' },
  'points.activity.detailsHide': { es: 'Ocultar',             en: 'Hide' },
  'points.activity.detailsFill': { es: 'fill',                en: 'fill' },
  'points.activity.detailsFills': { es: 'fills',              en: 'fills' },
  'points.activity.tapeEmpty': { es: 'Sin movimientos',       en: 'No moves yet' },
  'points.activity.tapeEmptySub': { es: 'Los trades aparecerán aquí cuando alguien compre o venda.', en: 'Trades appear here when someone buys or sells.' },
