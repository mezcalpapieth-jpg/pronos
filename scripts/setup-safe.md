...
2. Put testnet ETH and seed MockMXNB in the admin wallet.
3. Create markets from `/mvp/admin`; the wallet will approve MockMXNB and call `createMarket` directly.
...
4. Set `ADMIN_SAFE_ADDRESS` to the 3/5 Safe and `RESOLVER_SAFE_ADDRESS` to the 2/3 Safe
