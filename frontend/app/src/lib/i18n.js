...
const STRINGS = {
  ...
  'points.detail.orderBookHint':   { es: 'Órdenes reales de usuarios con liquidez AMM como respaldo ejecutable.', en: 'Real user orders with executable AMM liquidity as fallback.' },
