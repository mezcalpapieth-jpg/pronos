...
export async function fetchMe() {
  ...
  return data; // { authenticated, suborgId, username, email, walletAddress, balance, displayName, profileImageUrl, phoneNumber, reviewStatus, phoneRequired, apiBlockedAt, needsUsername }
}
