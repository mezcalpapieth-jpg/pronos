...
const STRINGS = {
  ...
  'points.detail.orderBook':       { es: 'Profundidad AMM',    en: 'AMM depth' },
  'points.detail.orderBookHint':   { es: 'Filas calculadas con cotizaciones ejecutables de compra y venta.', en: 'Rows are calculated from executable buy and sell quotes.' },
