...
const POINTS_SCHEMA_MIGRATIONS = [
  ...
  // automatically; admins use them to review prize eligibility when points
  // exploits or multi-accounting look likely.
  ...
  `ALTER TABLE points_cycle_snapshots ADD COLUMN IF NOT EXISTS conviction_bonus_gross NUMERIC(20,6)`,
  `ALTER TABLE points_cycle_snapshots ADD COLUMN IF NOT EXISTS conviction_bonus_cap_applied NUMERIC(20,6)`,
  `ALTER TABLE points_cycle_snapshots ADD COLUMN IF NOT EXISTS conviction_eligible_profit NUMERIC(20,6)`,
  `ALTER TABLE points_cycle_snapshots ADD COLUMN IF NOT EXISTS conviction_markets INTEGER`,
  `ALTER TABLE points_cycle_snapshots ADD COLUMN IF NOT EXISTS conviction_lots INTEGER`,
